...
public class ItemWaxingRecipe extends CustomRecipe {
            ...
            for (int i = 0; i < input.size(); i++) {
                ...
                if (!itemStack.isEmpty()) {
                    if (itemStack.is(Items.HONEYCOMB)) {
                        ...
                        if (!itemStack.is(OxidationData.OXIDIZABLE) || itemStack.has(OxidationData.WAXED)) return false;
    ...
    public @NotNull ItemStack assemble(CraftingInput input, HolderLookup.Provider registries) {
        ...
        for (int i = 0; i < input.size(); i++) {
            ...
            if (itemStack2.is(OxidationData.OXIDIZABLE)) {
                ...
                itemStack.set(OxidationData.WAXED, true);
            }
        }
        return itemStack;
    }
    ...
    public @NotNull RecipeSerializer<? extends CustomRecipe> getSerializer() {
        return OxidationData.ITEM_WAXING;
    }
}
