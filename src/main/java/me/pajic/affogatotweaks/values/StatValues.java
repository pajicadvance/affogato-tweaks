...
public class StatValues {
    ...
    public static final float GOLDEN_SWORD_ATTACK_SPEED = -1.6F;
    public static final float GOLDEN_PICKAXE_ATTACK_SPEED = -2.2F;
    public static final float GOLDEN_SHOVEL_ATTACK_SPEED = -2.5F;
    public static final float GOLDEN_HOE_ATTACK_SPEED = 0.0F;
}
