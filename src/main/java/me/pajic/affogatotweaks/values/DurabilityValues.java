...
public class DurabilityValues {
    ...
    public static final int LEATHER_ARMOR_MULT = 10;
    public static final int IRON_ARMOR_MULT = 10;
    public static final int GOLDEN_ARMOR_MULT = 5;
    public static final int DIAMOND_ARMOR_MULT = 20;
    public static final int NETHERITE_ARMOR_MULT = 50;
    public static final int TURTLE_ARMOR_MULT = 15;
    public static final int WOLF_ARMOR_MULT = 8;

    public static final int WOODEN_TOOL = 48;
    public static final int STONE_TOOL = 96;
    public static final int IRON_TOOL = 320;
    public static final int GOLDEN_TOOL = 96;
    public static final int DIAMOND_TOOL = 1024;
