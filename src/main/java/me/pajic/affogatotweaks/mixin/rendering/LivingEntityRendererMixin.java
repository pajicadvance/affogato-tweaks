package me.pajic.affogatotweaks.mixin.rendering;
...
public abstract class LivingEntityRendererMixin<T extends LivingEntity, M extends EntityModel<T>>  {
    ...
    private boolean renderZombiePowerLayer(
        ...
        if (entity instanceof Zombie zombie && zombie.getEntityData().get(Main.IS_LEADER)) {
            ...
            VertexConsumer vertexConsumer = bufferSource.getBuffer(RenderType.energySwirl(ResourceLocation.withDefaultNamespace("textures/entity/zombie/zombie_leader.png"), (f * 0.01F) % 1.0F, f * 0.01F % 1.0F));
